...
<head>
    <title>Registracija neuspeh</title>
</head>
        ...
        <?php echo form_open('registracija/checkRegistration'); ?>
            <center>
                <div class="forma">
                    ...
                    <?php if($neuspeh == 1) { ?>
                        <font color="red" size="3" face="verdana">Korisničko ime je zauzeto.</font><br>
                    <?php } ?>
                    <br>
                ...
                <?php if($neuspeh == 2) { ?>
                    <br><br>
                    <font color="red" size="3" face="verdana">Format je neispravan. Pokušajte ponovo.</font>
                <?php } ?>
