 ...
 * @Ana Bozovic 397/14
 */
class dodajPonuduNocna extends CI_Controller{
    ...
    public function index(){
        ...
        $this->load->view('dodajPonuduNocna');
    }
    ...
    public function verifyOffer(){
        ...
        $this->load->model('dodajPonuduNocnaM');
        $res=$this->dodajPonuduNocnaM->setOffer($naziv, $opis, $lokacija, $preporuceno, $brojStolova, $brojVisokih, $datum,$brojSeparea,$slika1,$slika2,$slika3);
        if ($res){
            return true;
        }else {
            $this->form_validation->set_message('verifyOffer','Forma nije ispravna. Pokušajte ponovo.');
